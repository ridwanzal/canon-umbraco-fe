  ...
  <section class="w-full py-8 bg-white-50 bg-white mb-[40px]">
    <div class="container">
      ...
      >
        ...
        <div class="ml-auto" @click="openModal">
          <svg
            width="33"
            height="32"
            viewBox="0 0 33 32"
      ...
      <div class="flex justify-center gap-4 mb-[48px] show-flex-desktop">
        ...
        <div class="relative min-w-[200px]" ref="countryDropdownRef">
          ...
          <ul
            v-if="openCountry"
            class="absolute w-[80%] left-[10%] bg-white border-[#E7E8E9] mt-1 z-10"
          >
            <li
      ...
      <div
        ...
        class="custom-pagination swiper-pagination"
      ></div>
    </div>
  </section>
...
export default {
  ...
  setup() {
    ...
    const paginationOptions = computed(() => {
      return filteredCars.value.length > 0
        ? {
        ...
        : false; // disables pagination if no slides
    });
